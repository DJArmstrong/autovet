...
#                    print '\tNo conclusion.'
    ...
    def plot_phase_folded_curves(self):
        ...
        print '******'
        print self.dic['SYSREM_FLUX3_PHASE']
